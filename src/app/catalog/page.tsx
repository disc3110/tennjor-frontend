...
// --- Existing ProductList component (unchanged) ---
        ...
        return (
          ...
          >
            <div className="relative">
              ...
              <div className="hidden md:block pointer-events-none absolute inset-x-3 bottom-3 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
                <button
                  type="button"
                  onClick={() => handleQuickAdd(product)}
                  className="pointer-events-auto w-full rounded-full bg-[var(--foreground)] px-4 py-2 text-xs font-semibold text-white hover:bg-black transition-colors"
                >
            ...
            <div className="flex flex-col gap-2 p-4">
              ...
              {/* Mobile quick add (no hover) */}
              <div className="mt-1 grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() => handleQuickAdd(product)}
                  className="md:hidden inline-flex items-center justify-center rounded-full bg-[var(--foreground)] px-3 py-2 text-xs font-semibold text-white hover:bg-black transition-colors"
                >
                  + Cotizar
                </button>
                ...
                <Link
                  ...
                  className="col-span-2 md:col-span-2 inline-flex justify-center rounded-full border border-[var(--foreground)]/20 bg-[var(--card)] px-4 py-2 text-xs font-medium text-[var(--foreground)] hover:border-[var(--foreground)]/35 hover:bg-[var(--card-2)] transition-colors"
                >
                  Ver detalles
                </Link>
              </div>
